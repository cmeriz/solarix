...
<body class="theme">
    ...
    <div class="login-container">
            ...
            <div class="login__form-container">
                <form class="login__form">
                    ...
                    <div class="login__form__row login__form__remember-forgot">
                        ...
                        <a href="./forgot-password.php" class="login__form__link">
                            Forgot my password
                        </a>
                    </div>
                    ...
                    <div class="login__form__row">
                        <p>
                            Don't have an account? <a href="./register.php" class="login__form__link">Register here</a>
                        </p>
                    </div>
        ...
        <section class="banner banner--login">
