...
<body class="theme">
    ...
    <section class="guest login">
        <header class="guest__header login__header">
        ...
        <div class="guest__container">
            <div class="guest__form-container login__form-container">
                <h1 class="guest__title">
                    Log in
                </h1>
                <form class="guest__form login__form">
                    <!-- Email -->
                    <div class="guest__form__row login__form__row">
                    ...
                    <div class="guest__form__row login__form__row login__form__remember-forgot">
                        ...
                        <a href="./forgot-password.php" class="guest__form__link">
                            Forgot my password
                        </a>
                    </div>
                    ...
                    <div class="guest__form__row login__form__row">
                        <p>
                            Don't have an account? <a href="./register.php" class="guest__form__link">Register here</a>
                        </p>
                    </div>

                </form>
            </div>
            <section class="guest__banner login__banner guest__banner--login">
