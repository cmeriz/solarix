...
<body class="theme">
    ...
    <section class="guest register">
        <header class="guest__header register__header">
            <div class="guest__header__content">
                <a class="logo" href="./">
        ...
        <div class="guest__container">
            <section class="guest__banner guest__banner--register">
                <div class="guest__banner__container">
                    <div class="guest__banner__content">
                        <h2 class="guest__banner__title">
                            Join the best community
                        </h2>
                        <p class="guest__banner__paragraph">
                            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Explicabo vitae dignissimos cupiditate aut, doloribus ad. Aut eveniet impedit tempora id perspiciatis, ipsam animi praesentium.
                        </p>
                    </div>
                    <footer class="guest__banner__footer">
                        <p class="guest__banner__copyright">
                            &copy;Solarix <?= date("Y"); ?>. Developed by <a class="guest__banner__footer__link" href="#">@cmeriz</a>
                        </p>
                        <ul class="guest__banner__social">
                            <li class="guest__banner__social__item">
                                <a href="#" class="guest__banner__social__link">
                                    <svg class="guest__banner__social__icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512">
                            ...
                            <li class="guest__banner__social__item">
                                <a href="#" class="guest__banner__social__link">
                                    <svg class="guest__banner__social__icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                            ...
                            <li class="guest__banner__social__item">
                                <a href="#" class="guest__banner__social__link">
                                    <svg class="guest__banner__social__icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
            ...
            <div class="guest__form-container register__form-container">
                <h1 class="guest__title">
                    Create an account
                </h1>
                <form class="guest__form register__form">
                    <div class="register__form__row register__form__firstname-lastname">
                        <!-- Firstname -->
                        <div class="form-input form-input--text">
                            <label class="form-input__label" for="firstname">
                                Firstname
                            </label>
                            <input class="form-input--text__field" id="firstname" autocomplete="off" name="text" type="text" placeholder="Firstname">
                        </div>
                        <!-- Lastname -->
                        <div class="form-input form-input--text">
                            <label class="form-input__label" for="lastname">
                                Lastname
                            </label>
                            <input class="form-input--text__field" id="lastname" autocomplete="off" name="text" type="text" placeholder="Lastname">
                        </div>
                    </div>
                    ...
                    <div class="register__form__row">
                        <div class="form-input form-input--password">
                            <label class="form-input__label" for="password-confirm">
                                Confirm password
                            </label>
                            <input class="form-input--password__field" id="password-confirm" autocomplete="off" name="password" type="password" placeholder="Confirm password">
                            <button class="form-input--password__btn" type="button">
                                <svg class="feather form-input--password__btn__icon--show">
                                    <use href="./src/icons/feather-sprite.svg#eye" />
                                </svg>
                    ...
                    <div class="register__form__row">
                        <div class="form-input form-input--checkbox">
                            ...
                            <div class="form-input--checkbox__option">
                                <input class="form-input--checkbox__field" id="terms-conditions" name="terms-conditions" type="checkbox" checked>
                                ...
                                <label for="terms-conditions">
                                    I have read <a class="register__form__link" href="#">Terms & Conditions</a>
                                </label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="register__form__row">
                        <div class="form-input form-input--checkbox">
                            ...
                            <div class="form-input--checkbox__option">
                                <input class="form-input--checkbox__field" id="newsletter" name="newsletter" type="checkbox" checked>
                                <span class="form-input--checkbox__not-checked"></span>
                                <span class="form-input--checkbox__checked">
                                    <svg class="feather">
                                        <use href="./src/icons/feather-sprite.svg#check" />
                    ...
                    <div class="register__form__row">
                        <button class="btn--primary guest__form__btn-submit" type="submit">
                            Create account
                        </button>
                    </div>
                    ...
                    <div class="register__form__row">
                        <p>
                            Already have an account? <a href="./login.php" class="guest__form__link">Log in</a>.
                        </p>
                    </div>
