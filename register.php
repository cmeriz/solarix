        ...
        <section class="banner banner--register">
            <div class="banner__container">
                ...
                <footer class="banner__footer">
                    <p class="banner__copyright">
                        &copy;Solarix <?= date("Y"); ?>. Developed by <a class="banner__footer__link" href="#">@cmeriz</a>
                    </p>
                    <ul class="banner__social">
                        <li class="banner__social__item">
                            <a href="#" class="banner__social__link">
                                <svg class="banner__social__icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512">
                        ...
                        <li class="banner__social__item">
                            <a href="#" class="banner__social__link">
                                <svg class="banner__social__icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                        ...
                        <li class="banner__social__item">
                            <a href="#" class="banner__social__link">
                                <svg class="banner__social__icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
        ...
        <section class="register">
            <div class="register__form-container">
                <form class="register__form">
                    ...
                    <div class="register__form__row">
                        <button class="btn--primary register__form__btn-submit" type="submit">
                            Create account
                        </button>
                    </div>
                    ...
                    <div class="register__form__row">
                        <p>
                            Already have an account? <a href="./login.php" class="register__form__link">Log in</a>.
                        </p>
                    </div>
